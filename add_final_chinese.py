...
additional_translations = {
    ...
    "Das OTA-Update war erfolgreich.": "OTA 更新成功。",
    ...
    "Erhalte Push-Benachrichtigungen, wenn der Respooler stoppt oder fertig ist.": 
        "当 Respooler 停止或完成时接收推送通知。",
    ...
    "Keine Updates mehr": "不再有更新",
    
    "LTS Respooler": "LTS Respooler",
    ...
    "Wähle aus, auf welcher Seite die Startposition der Filamentführung ist.": 
        "选择耗材引导装置的起始位置在哪一侧。",
...
# 添加翻译
added_count = 0
for key, translation in additional_translations.items():
    if key in data['strings']:
        ...
        added_count += 1
        print(f"✓ 已翻译：{key[:50]}... -> {translation[:30]}...")
