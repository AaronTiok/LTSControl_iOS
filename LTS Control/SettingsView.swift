...
struct SettingsView: View {
    ...
    private var targetWeightText: String {
        ...
        case 0:
            return NSLocalizedString("整卷", comment: "Respool Amount label: entire spool")
        case 1:
            return NSLocalizedString("1.0 公斤", comment: "Respool Amount label: 1.0 kg")
        case 2:
            return NSLocalizedString("0.5 公斤", comment: "Respool Amount label: 0.5 kg")
        case 3:
            return NSLocalizedString("0.25 公斤", comment: "Respool Amount label: 0.25 kg")
        default:
            return NSLocalizedString("整卷", comment: "Respool Amount label: entire spool")
        }
    }
    ...
    var body: some View {
        VStack {
            ...
            Section {
                ...
                Section(header: Text("风扇"), footer: Text("Der Lüfter schaltet sich standardmäßig 10 Sekunden nach stoppen des Respoolers aus.")
                ){
                    Stepper(
                        value: Binding(
...
private struct RespoolAmountView: View {
    ...
    private let entireOption: (title: String, tag: Int) = (
        NSLocalizedString("整卷", comment: "Respool Amount option: entire spool"),
        0
    )
    private let weightOptions: [(title: String, tag: Int)] = [
        (NSLocalizedString("1.0 公斤", comment: "Respool Amount option: 1.0 kg"), 1),
        (NSLocalizedString("0.5 公斤", comment: "Respool Amount option: 0.5 kg"), 2),
        (NSLocalizedString("0.25 公斤", comment: "Respool Amount option: 0.25 kg"), 3)
    ]
